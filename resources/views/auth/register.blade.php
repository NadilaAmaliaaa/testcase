						...
						<div class="content">
                            ...
                            <form class="form-auth-small" action="{{ url('/login') }}" method="post">
								...
								<div class="form-group">
									<input name="nama_petugas" type="text"  class="form-control" placeholder="Nama" required>
								</div>                           
								<div class="form-group">
								...
								<div class="bottom">
									<span class="helper-text"> <a href="/login">Back to Login</a></span>
								</div>
							</form>
						</div>
					</div>
					<div class="right" style="background-image: url('{{ asset('img/pp.png')}}');">
						<div class="overlay"></div>
						<div class="content text">
							<h1 class="heading">Bicycle community</h1>
							<p>by Pinkbike</p>
						</div>
					</div>
